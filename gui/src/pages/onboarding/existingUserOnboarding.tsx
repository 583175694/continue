    ...
    <TopDiv>
      <div className="m-auto p-2 max-w-96 mt-16 overflow-y-scroll">
        ...
        <p className="text-center pb-2">
          CodeMaster now integrates with higher quality cloud models for
        ...
        >
          ...
          <p>
            CodeMaster using fully local autocomplete + embeddings, or whichever
        ...
        >
          ...
          <p>
            CodeMaster's autocomplete and codebase retrieval will feel
