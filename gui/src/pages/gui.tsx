        ...
        <div className="max-w-3xl m-auto">
          <div id="read-box">
            <div className="welcome">
              <img
                src={`${window.vscMediaUrl}/icon-robert.gif`}
                alt=""
                width="148px"
                height="172px"
              />
            ...
            <p>
              使用<span> 快捷键 ⌘ ⇧ L </span>
              将选中代码加入上下文，在下方输入框中输入需求
            </p>
            <p>
              在代码框中按下<span> 快捷键 ⌘ I </span>弹出代码生成/优化命令框
            </p>
            <p>
              Tips：如果出现空白，没有回答内容的情况，请直接点击
              <span>停止响应</span>
            </p>
            <p>如有任何问题或需要支持，请随时联系kyroswu(吴少航)</p>
          </div>
          <StepsDiv>
