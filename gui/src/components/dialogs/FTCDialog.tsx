...
function FTCDialog() {
  ...
  return (
    <div className="p-4">
      ...
      <p>
        You've reached the free trial limit of 250 free inputs with CodeMaster's
        OpenAI API key. To keep using CodeMaster, you can either use your own API
        ...
        to open your CodeMaster config file and paste your API key into the
